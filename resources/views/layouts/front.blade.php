<!-- This is component view class -->
<!DOCTYPE html>
<html class="no-js" lang="zxx">

<head>
    <!-- copy the asset folder inside public to read browzer -->
    <meta charset="utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <!-- $title is define in view/compnent class in FrontLayout.php -->
    <title>{{$title}}</title>
...
<body>
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="top-end">
                            ...
                            <div class="user">
                                ...
                                <!-- you can add the guard use in dashboard -->
    ...
    <!-- in home.blade.php , use ?? if not define this breadcrumb -->
    {{$breadcrumb ?? ''}}

    <!-- End Breadcrumbs -->

    <!--component بس هشه داخل  @yeild شبيه  $slot لما استدعيه بنستخدم  component اي شغلة محصورة داخل  -->
    {{$slot}}
