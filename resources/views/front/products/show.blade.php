<!-- $product come from controller front/productcontroller -->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <!-- {{App\Helpers\Currency::format($product->price,'JOR')}} -->
                            <!-- i am create aliases in config app.php to write Currwncy Directlty -->
