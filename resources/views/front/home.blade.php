<!-- Use Component class not resourse component view -->
<!-- in this system frontLayout write front-layout -->
<!-- use class Name -->
<!-- in layout front or back good use component class is more good from back layout use in dashboard -->
<x-front-layout>
    <!-- This area is $slot -->


    <!-- This to define breadcrumb variable is define in compnent  -->
    {{--<x-slot name="breadcrumb">
        <!--  or    <x-slot:breadcrumb>  -->
    ...
    <section class="trending-product section">
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- $products are come from HomeController -->
                @foreach($products as $product)
                <div class="col-lg-3 col-md-6 col-12">
                    <!-- This Card is component name is product-card.blade.php -->
                    <!-- you should sen variable to component containe data -->
                    <!-- : => {{}} -->
                    <!-- the data handle in component -->
    ...
    @push('scripts')
    <!-- From index.html in dowland template -->
