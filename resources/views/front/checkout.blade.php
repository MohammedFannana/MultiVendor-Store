                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-input form">
                                                            <!-- use name in this way look CheckoutOrderController -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="select-items">
                                                        <x-form.input name="addr[billing][state]" placeholder="Region/State" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Region/State</label>
                                                    <div class="select-items">
                                                        <x-form.input name="addr[shipping][state]" placeholder="Post Code" />
                                                    </div>
                                                </div>
                                            </div>
